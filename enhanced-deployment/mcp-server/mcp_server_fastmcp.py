#!/usr/bin/env python3
"""
MCP Server for Telepath AI - Uses FastMCP for HTTP streaming (EXACT MATCH)
"""
...
# Create the MCP server - EXACT SAME AS ORIGINAL
...
def log_audit(action: str, request: Dict, response: Dict):
    ...
    logger.info(f"📋 🎉 CLAUDE USED A TOOL! 🎉 Audit: {audit_entry}")
...
if __name__ == "__main__":
    print(f"🚀 Running Telepath MCP Server (EXACT FASTMCP MATCH) on {HOST}:{PORT}")
